...
class projectstaskRoute implements Route {
  ...
  private initializeRoutes() {
    ...
    this.router.put(`${this.path}/updateprojects_taskbyid/:id`, this.projectstaskcontroller.updateById);
    this.router.post(`${this.path}/deleteprojects_taskbyid`, validationMiddleware(ProjectsTaskDto, 'body', true, []), (req, res, next) => this.projectstaskcontroller.getDeletedprojectstask(req, res, next));
